...
function cavani_tm_page_transition(){
	...
	var allLiDesktop    = jQuery('.cavani_tm_header .menu .transition_link li');
	var button			= jQuery('.transition_link a');
	var wrapper 		= jQuery('.cavani_tm_all_wrap');
	var moreBtn         = jQuery('.more_btn')
	...
	moreBtn.on('click',function(){
		...
		console.log(allLiDesktop)
		allLiDesktop.removeClass('active');
		allLiDesktop.first().addClass('active');
	})
}
...
function cavani_tm_smoothscroll() {
